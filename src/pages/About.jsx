        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          >
            <p className="text-2xl md:text-3xl text-ink font-serif leading-snug mb-10 text-center">
              Alzina Attorneys was established to provide sophisticated legal
              solutions that help our clients navigate complexity, manage risks,
              and make informed business decisions.
            </p>
            <p className="mb-6">
              Our practice is founded on the principles of excellence,
              commercial pragmatism, and a deep understanding of the regulatory
              landscapes in which our clients operate. We approach every legal
              challenge not just as lawyers, but as strategic partners dedicated
              to your long-term success.
            </p>
            <p>
              By combining rigorous legal scholarship with practical business
              acumen, we ensure that our representation is both formidable in
              dispute resolution and highly effective in corporate negotiations.
              At Alzina Attorneys, our commitment is simple: we deliver results
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-start">
            ...
            <div className="md:w-7/12 py-4 md:py-12">
              ...
              >
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-white/50 mb-8">
                    Biography
                  </h3>
                  <div className="space-y-6">
                    <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
                      Pascal Zimuzo Ozuligbo is a highly regarded legal
                      practitioner known for his sharp commercial insight and
                      unwavering dedication to his clients. With extensive
                      experience across multiple practice areas, he brings a
                      strategic and results-driven approach to every mandate.
                    </p>
                    <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
                      Under his leadership, Alzina Attorneys has grown into a
                      formidable practice, recognized for setting bold new
                      levels of legal excellence. His counsel is sought after by
                      corporations, high-net-worth individuals, and emerging
                      enterprises navigating complex legal and regulatory
                      environments.
                    </p>
                  </div>
                </div>
                ...
                <div className="border-t border-white/20 pt-10">
                  <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-ink-muted mb-8">
                    Education & Certifications
                  </h3>
                  <div className="space-y-6">
                    <p className="text-xl md:text-2xl text-white/90 font-serif italic border-l-[3px] border-accent pl-6">
                      B.L., Nigerian Law School (Enugu Campus)
                    </p>
                    <p className="text-xl md:text-2xl text-white/90 font-serif italic border-l-[3px] border-accent pl-6">
                      LL.B, Chukwuemeka Odumegwu Ojukwu University, Igbariam
                    </p>
                    <p className="text-xl md:text-2xl text-white/90 font-serif italic border-l-[3px] border-accent pl-6">
                      B.A (International Relations), Nnamdi Azikiwe University,
                      Awka
                    </p>
                    <p className="text-xl md:text-2xl text-white/90 font-serif italic border-l-[3px] border-accent pl-6">
                      Diploma in French, Université D’Abomey Calavi, Benin
                      Republic
                    </p>
                  </div>
                </div>
